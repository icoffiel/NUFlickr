...
import com.nerdery.university.coffield.nuflickr.dependencyinjection.modules.ActivityModule;
...
public abstract class BaseActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BaseProjectApplication application = BaseProjectApplication.getInstance();
